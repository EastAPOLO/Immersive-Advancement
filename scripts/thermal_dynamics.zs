...
var hardened_enderium_glass = <thermalfoundation:glass_alloy:7>;
var redstone_block = <minecraft:redstone_block>;
var gelid_cryotheum_bucket = <forge:bucketfilled>.withTag({FluidName: "cryotheum", Amount: 1000});
...
recipes.addShaped(cryo_stabilized_fluxduct, [
[hardened_enderium_glass, gelid_cryotheum_bucket, hardened_enderium_glass],
