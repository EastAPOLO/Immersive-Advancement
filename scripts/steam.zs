...
mods.immersivetechnology.Boiler.addRecipe(<liquid:low_pressure_steam> * 3072, <liquid:distwater> * 768, 1);
...
mods.immersivetechnology.SteamTurbine.addFuel(<liquid:exhauststeam> * 3072, <liquid:low_pressure_steam> * 3072, 1);
mods.immersivetechnology.HighPressureSteamTurbine.addFuel(<liquid:exhauststeam> * 1536, <liquid:high_pressure_steam> * 1536, 1);
