...
var transferIn = [<fluid:water>,<fluid:preheated_water>, <fluid:exhaust_steam>,<fluid:condensate_water>,<fluid:well_pressed_water>,<fluid:crap_steam>] as IIngredient[];
...
for i,array in crMatrix{
	for j,num in array{
		...
		mods.immersivetechnology.HeatExchanger.addRecipe(coolantOut[j].amount(coolModifier[i]), transferOut[i].amount(num*transferModifier[i]), coolantIn[j].amount(coolModifier[i]), transferIn[i].amount(num), 0, 1);
	}
}
...
mods.immersivetechnology.HeatExchanger.addRecipe(<fluid:steam>*300, <fluid:low_pressure_steam>*120, <fluid:high_pressure_steam>*75, <fluid:exhaust_steam>*120, 0, 1);
mods.immersivetechnology.HeatExchanger.addRecipe(<fluid:steam>*320, <fluid:preheated_water>*16, <fluid:high_pressure_steam>*80, <fluid:condensate_water>*16, 0, 1);
...
mods.immersivetechnology.HeatExchanger.addRecipe(<fluid:steam>*5120, <fluid:high_pressure_steam>*672, <fluid:super_critical_steam>*80, <fluid:crap_steam>*672, 0, 1)
mods.immersivetechnology.HeatExchanger.addRecipe(<fluid:steam>*320, <fluid:low_pressure_steam>*448, <fluid:super_critical_steam>*5, <fluid:exhaust_steam>*448, 0, 1)
mods.immersivetechnology.HeatExchanger.addRecipe(<fluid:steam>*1280, <fluid:preheated_water>*224, <fluid:super_critical_steam>*20, <fluid:condensate_water>*224, 0, 1)
...
mods.nuclearcraft.FissionIrradiator.addRecipe(<ore:ingotPrometheum>, <ore:dustPromethium147>, 282000, 0.0, 0.0, 0.0);
}
...
mods.immersivetechnology.HeatExchanger.addRecipe(coolantOut[j].amount(<fluid:corium_nak>*60, <fluid:condensate_water>*125, <fluid:corium_nak_hot>*60, <fluid:preheated_water>*125, 0, 1)
...
mods.nuclearcraft.FissionIrradiator.addRecipe(<forge:bucketfilled>.withTag({FluidName: "lithium_6", Amount: 1000}), <forge:bucketfilled>.withTag({FluidName: "tritium", Amount: 1000}), 23000, 0.01, 0.0, 0.0);
